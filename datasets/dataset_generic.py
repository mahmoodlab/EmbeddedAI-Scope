...
class Generic_WSI_Classification_Dataset(Dataset):
	def __init__(self,
		...
		slide_data = self.df_prep(slide_data, self.label_dict, ignore, self.label_col, multi_site, filter_dict)
	...
	@staticmethod
	def df_prep(data, label_dict, ignore, label_col, multi_site=False, filter_dict={}):
		if label_col != 'label':
